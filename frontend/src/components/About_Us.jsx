...
import "../styles/About_Us.css";  // ✅ Keep a separate CSS file
    ...
    <div className="about-container">
      ...
      <header className="about-header">
        ...
        <p className="about-header-text">
          This aims to aid Barangay Officials in managing and keeping their records through an online website wherein
          the documents stored, such as Ordinance, Resolution, Proposal, and others which are proposed and enacted by
          Barangays, are distinguished with which administrative term they were uploaded.
        </p>
