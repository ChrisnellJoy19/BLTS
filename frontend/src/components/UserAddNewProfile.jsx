        ...
        <form onSubmit={handleSubmit} className="bg-white p-4 md:p-6 rounded-lg shadow-lg w-full max-w-3xl mx-auto mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" name="punongBarangay"onChange={handleInputChange} className="border p-2 w-full" />

              <label className="block font-semibold mt-2">Barangay Secretary</label>
              <input type="text" name="barangaySecretary"  onChange={handleInputChange} className="border p-2 w-full" />

              <label className="block font-semibold mt-2">Email</label>
              <input type="email" name="email" onChange={handleInputChange} className="border p-2 w-full" />
            ...
            <div>
              ...
              <div className="overflow-y-auto h-40 border p-2">
                {formData.sbMembers.map((member, index) => (
                  <input key={index} type="text" onChange={(e) => handleInputChange(e, index)} className="border p-2 w-full mb-1" />
                ))}
              </div>
              <label className="block font-semibold mt-2">Sangguniang Kabataan Chairperson</label>
              <input type="text" name="sangguniangKabataan" onChange={handleInputChange} className="border p-2 w-full" />
